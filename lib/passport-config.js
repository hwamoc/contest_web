...
module.exports = function(passport) {
  ...
  'https://secret-bastion-71502.herokuapp.com/auth/facebook/callback' :
  'http://localhost:3000/auth/facebook/callback';
  
  passport.use(new FacebookStrategy({
    // 이 부분을 여러분 Facebook App의 정보로 수정해야 합니다.
    clientID : process.env.FBID || '412441582625852',
    clientSecret : process.env.FB_SECRET || '11101a5f69c8bcca47d9df330e0c366d',
